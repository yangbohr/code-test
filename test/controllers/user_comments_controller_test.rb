...
class UserCommentsControllerTest < ActionController::TestCase
  ...
  test "should create user_comment" do
    assert_difference('UserComment.count') do
      post :create, user_comment: { creation_time: @user_comment.creation_time, follower: @user_comment.follower, handle: @user_comment.handle, score: @user_comment.score, user_id: @user_comment.user_id }
    end
  ...
  test "should update user_comment" do
    patch :update, id: @user_comment, user_comment: { creation_time: @user_comment.creation_time, follower: @user_comment.follower, handle: @user_comment.handle, score: @user_comment.score, user_id: @user_comment.user_id }
    assert_redirected_to user_comment_path(assigns(:user_comment))
  end
